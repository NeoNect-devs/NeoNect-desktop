...
* ✔️ standard RFC 7230 Host/Origin headers, TLS SNI peer verification, and exponential backoff (`2501220`)
...
* ✔️ automate changelog and patch notes synchronization for docs site and GitHub draft release (`8990b12`)
